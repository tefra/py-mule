...
class CountryViewSetTestCase(TestCase):
    def test_properties(self):
        ...
        self.assertEqual("[a-z]{2}", CountryViewSet.lookup_value_regex)
...
class AirportViewSetTestCase(TestCase):
    def test_properties(self):
        ...
        self.assertEqual("[a-z]{3}", AirportViewSet.lookup_value_regex)
...
class AirlineViewSetTestCase(TestCase):
    def test_properties(self):
        ...
        self.assertEqual("[a-z0-9]{2}", AirlineViewSet.lookup_value_regex)
